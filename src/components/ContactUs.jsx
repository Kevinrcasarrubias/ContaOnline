...
const ContactUs = () => {
  ...
  return (
    ...
    <form 
         className="grid grid-cols-1 grid-rows-6 w-full h-[130vh] mt-[30rem] space-y-1 xxl:grid-cols-2 xxl:grid-rows-4 xxl:h-[80vh] xxl:mt-[6rem] xxl:mb-[5rem]"
         id="contactanos"
         ref={form}
         onSubmit={sendEmail}
         >
       <h2 className="grid m-[1rem] col-start-1 row-start-1 font-montserrat text-[40px] justify-center items-center font-bold text-red-600 xxl:col-start-1 xxl:col-span-2 xxl:justify-center xxl:text-[60px]">¡Contáctanos!</h2>
       <div className="grid col-start-1 row-start-2 items-center justify-center xxl:col-start-1 xxl:grid-start-2">
       ...
       <div className="grid col-start-1 row-start-6 items-center justify-center xxl:col-start-1 xxl:col-span-2 xxl:row-start-4 xxl:items-center">
          <button 
                 className="font-montserrat text-[20px] w-[140px] h-[50px] mt-[3rem] mb-[2rem] xxl:w-[240px] xxl:h-[70px] xxl:text-[25px] text-white rounded-lg bg-red-600 hover:bg-red-800 hover:pointer"
                 type="submit"
          >
           Enviar
          </button>
